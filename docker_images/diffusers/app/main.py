...
from app.pipelines import Pipeline, TextToImagePipeline, ImageToImagePipeline
...
ALLOWED_TASKS: Dict[str, Type[Pipeline]] = {"text-to-image": TextToImagePipeline, "image-to-image": ImageToImagePipeline}
